...
namespace NET_Mom3.Controllers
{
    public class CDController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PublishedDate,Tracks,Length")] CD cD)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PublishedDate,Tracks,Length")] CD cD)
        {
            if (id != cD.Id)
            {
                return NotFound();
